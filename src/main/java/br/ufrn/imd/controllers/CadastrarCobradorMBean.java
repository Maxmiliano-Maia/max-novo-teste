...
public class CadastrarCobradorMBean {
    ...
    private List<Cobrador> cobradoresf; 

    public CadastrarCobradorMBean() {
        cobrador = new Cobrador();
        cobradores = new ArrayList<Cobrador>();
        cobradoresf = new ArrayList<Cobrador>();
    }
    ...
    public String listar() {
    	...
    	return "/list_cobrador.jsf";
    	
    }
    
    public String TelaExcluir() {
    	
    	return "/del_cobrador.jsf";
    ...
    public String excluir() {
        ...
        cobradorDao.tentarExcluir(cobrador);
        cobradoresf = cobradorDao.buscarTodosCobradores();
        cobrador = new Cobrador();
     
        
        if (cobradores.size() == cobradoresf.size()) {
        	
        	 FacesMessage msg = new FacesMessage("Cobrador Inexistente");
             msg.setSeverity(FacesMessage.SEVERITY_INFO);
             FacesContext.getCurrentInstance().addMessage("", msg);
        	  ...
        	  FacesMessage msg = new FacesMessage("Cobrador excluido com sucesso!");
              msg.setSeverity(FacesMessage.SEVERITY_INFO);
              FacesContext.getCurrentInstance().addMessage("", msg);
